...
\begin{document}
  ...
  \chapter{Versuchsdurchführung und -auswertung}
    ...
    \section{Kohlenstoffwasserstoff-Ringe}
      ...
      \begin{figure}[tb]
        ...
        \end{tikzpicture}
        \label{fig:benzol-ring}
        }
        \caption[Spektren der Kohlenstoffwasserstoff-Ringe und exemplarische Struktur eines Benzolrings.]{Spektren der Kohlenstoffwasserstoff-Ringe \protect\subref{fig:c6h6} $\mathrm{C_6H_6}$, \protect\subref{fig:c6h12} $\mathrm{C_6H_{12}}$, \protect\subref{fig:c6h5no2} $\mathrm{C_6H_5NO_2}$. \protect\subref{fig:benzol-ring} zeigt die Struktur eines Benzolrings.}
        \label{fig:ringe}
      \end{figure}
  ...
  \section{Messung der Temperatur von Schwefel}
