...
\begin{abstract}
  During the experiment, the characteristic lines of chloromethanes and carbon rings were observed using Raman-spectroscopy. For the chloromethanes, most of the lines could be associated with specific vibrations of the molecules. Resonances with a difference in Raman-shift down to $\Delta \nu=\SI{80}{\per\centi\meter}$ could be resolved. Furthermore, the temperatue of a sulfur sample at room temperature has been determined to be $\SI{19}{\celsius}$ using Raman-spectroscopy. Last, the concentration of ethanol in an unknown ethanol-water-mixture has been derived to be $\SI{29}{\percent}$, again using the Raman-effect.
\end{abstract}
